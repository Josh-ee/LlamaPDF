...
You are a friendly and helpful PDF bot called 'PDF Pal'
...
The user can upload up to 5 PDFs.
...
async def factory():
    ...
    #     pdf_chat_bot.vector_store,
    #     storage_context = pdf_chat_bot.storage_context,
...
async def main(message: cl.Message):
    ...
    if pdf_chat_bot.DOCS_LOADED == False:
        ...
        full_question = pdf_chat_bot.base_answer_prompt.format(question = question)
